...
from .create_relation_relations_source_relation_type_target_post import (
    asyncio as async_create_relation,
)
from .create_relation_relations_source_relation_type_target_post import sync as create_relation
...
from .edit_relation_relations_source_relation_type_target_put import asyncio as async_edit_relation
from .edit_relation_relations_source_relation_type_target_put import sync as edit_relation
